<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Usuarios.aspx.vb" Inherits="ProyectoDMS.Usuarios" %>
...
<body>
    <form id="form1" runat="server" class="auto-style7">
        ...
        <table class="auto-style6">
            <tr>
                <td class="auto-style1">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="XX-Large" Text="REGISTRO Y/O MANTENIMIENTO DE USUARIOS"></asp:Label>
                </td>
            </tr>
        </table>
        <table style="width: 100%;">
            ...
            <tr>
                <td class="auto-style8">FOTO PERFIL</td>
                <td class="auto-style2">
                    <asp:TextBox ID="TextBox2" runat="server" Width="215px"></asp:TextBox>
                </td>
                <td class="auto-style5">
                    <asp:Button ID="BtnSeleccion" runat="server" Text="Seleccionar" Width="119px" />
                </td>
                <td class="auto-style4">&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td class="auto-style8">PERFIL</td>
                <td class="auto-style2">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="800px" >
            <Columns>
                ...
                <asp:BoundField DataField="Img" HeaderText="IMGEN PERFIL" />
                <asp:BoundField DataField="ImProfile" HeaderText="PERFIL" />
